#!/usr/bin/env python3
"""Subscriber on Domain 1 - receives SAME type (no transformation)."""
...
def main():
    ...
    print(f"Waiting for SensorData on Domain {args.domain}...", file=sys.stderr)
    ...
    print(f"\nReceived {received} samples on Domain {args.domain}", file=sys.stderr)
